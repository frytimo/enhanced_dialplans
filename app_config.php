...
$apps[$x]['default_settings'][$y]['default_setting_category'] = "dialplan";
$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "editor_default";
$apps[$x]['default_settings'][$y]['default_setting_name'] = "text";
$apps[$x]['default_settings'][$y]['default_setting_value'] = "legacy";
$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "true";
$apps[$x]['default_settings'][$y]['default_setting_description'] = "Default dialplan editor version for new dialplans. Options: legacy, unified";
$y++;
$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "b2c3d4e5-f6a7-8901-bcde-f12345678901";
$apps[$x]['default_settings'][$y]['default_setting_category'] = "dialplan";
$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "store_details";
$apps[$x]['default_settings'][$y]['default_setting_name'] = "boolean";
$apps[$x]['default_settings'][$y]['default_setting_value'] = "true";
$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "true";
$apps[$x]['default_settings'][$y]['default_setting_description'] = "When restoring a dialplan to its original, also populate v_dialplan_details so the legacy dialplan editor can display and edit the conditions and actions.";
$y++;
$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "3634f554-da99-4845-bc7c-ee7ab9525bba";
$apps[$x]['default_settings'][$y]['default_setting_category'] = "theme";
$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "dialplan_editor_led_color";
$apps[$x]['default_settings'][$y]['default_setting_name'] = "text";
$apps[$x]['default_settings'][$y]['default_setting_value'] = "#40bb62";
$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "true";
$apps[$x]['default_settings'][$y]['default_setting_description'] = "LED colour used for the dialplan editor node strip, BREAK buttons, and INLINE rocker. Accepts any CSS hex colour e.g. #40bb62";
$y++;
$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "fd6da431-0c75-4e67-9c64-0c06dbf2207a";
$apps[$x]['default_settings'][$y]['default_setting_category'] = "theme";
$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "dialplan_editor_led_node_enabled";
$apps[$x]['default_settings'][$y]['default_setting_name'] = "boolean";
$apps[$x]['default_settings'][$y]['default_setting_value'] = "true";
$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "true";
$apps[$x]['default_settings'][$y]['default_setting_description'] = "Show the LED indicator on the CONDITION, ACTION, REGEX, etc. drag-zone bars in the dialplan editor.";
$y++;
$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "58888df3-4c0e-4e67-92e8-fb47f0a87a5f";
$apps[$x]['default_settings'][$y]['default_setting_category'] = "theme";
$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "dialplan_editor_led_break_enabled";
$apps[$x]['default_settings'][$y]['default_setting_name'] = "boolean";
$apps[$x]['default_settings'][$y]['default_setting_value'] = "true";
$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "true";
$apps[$x]['default_settings'][$y]['default_setting_description'] = "Show the LED indicator on the BREAK button group in the dialplan editor.";
$y++;
$apps[$x]['default_settings'][$y]['default_setting_uuid'] = "01f64dc5-5895-483a-98d1-48fed9b72374";
$apps[$x]['default_settings'][$y]['default_setting_category'] = "theme";
$apps[$x]['default_settings'][$y]['default_setting_subcategory'] = "dialplan_editor_led_inline_enabled";
$apps[$x]['default_settings'][$y]['default_setting_name'] = "boolean";
$apps[$x]['default_settings'][$y]['default_setting_value'] = "true";
$apps[$x]['default_settings'][$y]['default_setting_enabled'] = "true";
$apps[$x]['default_settings'][$y]['default_setting_description'] = "Show the LED indicator on the INLINE True/False rocker buttons in the dialplan editor.";
$y++;
...
$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "";
$z++;
$apps[$x]['db'][$y]['fields'][$z]['name'] = "dialplan_editor_version";
$apps[$x]['db'][$y]['fields'][$z]['type'] = "text";
$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Tracks which editor version manages this dialplan: legacy or unified.";
$z++;
$apps[$x]['db'][$y]['fields'][$z]['name'] = "dialplan_hash";
$apps[$x]['db'][$y]['fields'][$z]['type']['pgsql'] = "text";
$apps[$x]['db'][$y]['fields'][$z]['type']['sqlite'] = "text";
$apps[$x]['db'][$y]['fields'][$z]['type']['mysql'] = "varchar(32)";
$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Canonical XML hash of the shipped baseline this dialplan was installed from. Populated during upgrade by the enhanced_dialplans app_defaults.";
$z++;
$apps[$x]['db'][$y]['fields'][$z]['name'] = "dialplan_enabled_original";
$apps[$x]['db'][$y]['fields'][$z]['type'] = "boolean";
$apps[$x]['db'][$y]['fields'][$z]['description']['en-us'] = "Enabled state declared by the shipped baseline XML file (<extension enabled=...>). Populated during upgrade by the enhanced_dialplans app_defaults.";
$z++;
